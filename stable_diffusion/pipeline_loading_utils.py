...
from diffusers.pipelines.transformers_loading_utils import _load_tokenizer_from_dduf, _load_transformers_model_from_dduf
...
def get_class_obj_and_candidates(
    ...
    if is_pipeline_module:
        ...
        if class_name == 'UNet2DConditionModel':
            library_name = "stable_diffusion.unet_2d_condition"
        library = importlib.import_module(library_name)
